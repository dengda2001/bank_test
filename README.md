...
- Demo admin username with `APP_ADMIN_USERNAME`. Defaults to `admin`.
- Demo admin password with `APP_ADMIN_PASSWORD`. Defaults to `password`.
...
APP_ADMIN_PASSWORD=choose-a-local-demo-password
