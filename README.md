...
- Tentative rent-month suggestion switches to the next month from day 15 of the bank's `Europe/Dublin` posting date. Set `RENT_NEXT_MONTH_FROM_DAY=1..31` to adjust the day (invalid values use 15). This suggestion requires confirmation and never triggers automatic allocation; a description with an explicit rent month takes priority.
