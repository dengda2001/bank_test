# 6dfc49e4-77f1-493a-b618-a659eff7d3a8 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `rentops-desktop-suite.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `rentops-desktop-suite.html`
...
- A single self-contained `rentops-desktop-suite.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `rentops-desktop-suite.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `rentops-desktop-suite.html`
- `rentops-mobile-suite.html`
...
1. Inspect `rentops-desktop-suite.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
