...
- [ ] EUR 1,000 两人 600/400 的责任合计正确。
- [ ] 一人支付 EUR 1,000 时，两位租客责任均结清，并显示代付来源。
- [ ] 一人支付 EUR 800 时，只自动覆盖本人责任，剩余金额待人工确认。
- [ ] 超付不会制造负未收；撤销后所有受影响责任和房间状态正确回退。
- [ ] 重复生成、重复提交和并发分配不会重复记账或超过可分配余额。
