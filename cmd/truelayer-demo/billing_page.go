        ...
        <div class="table-wrap"><table class="transaction-table">
          ...
          <tbody>{{range .TransactionRows}}
            <tr class="{{.Direction}}">
              ...
              <td class="txn-col-payer"><div class="match-metadata"><strong>{{.PayerName}}</strong></div></td>
