	...
	write("rent-workspace.html", func() error {
		return writeFile("rent-workspace.html", func(body *strings.Builder) error {
			...
			return rentWorkspaceTemplate.Execute(body, rentWorkspacePageData{
				...
				Summary:      rentWorkspaceSummary{ExpectedAmount: "€26,210", PaidAmount: "€22,790", BalanceAmount: "€3,420", ExpenseAmount: "€1,600", NetAmount: "€21,190", CollectionPercent: 86, TotalRooms: 25, PaidRooms: 15, UnpaidRooms: 7, VacantRooms: 3, ResponsibilityCount: 40, FollowupCount: 4},
				PendingCount: 3, PendingItems: []rentWorkspacePendingItem{{Title: "WAHAJULLAH KHAN", Subtitle: "09-01 · 同住代付待确认", Amount: "€1,250", DetailURL: "/transactions?detail=10&period=2026-09", ListURL: "/transactions?period=2026-09&match_status=pending"}, {Title: "付款人待识别", Subtitle: "09-04 · AIB · RENT SEPT", Amount: "€800", DetailURL: "/transactions?detail=11&period=2026-09", ListURL: "/transactions?period=2026-09&match_status=pending"}}, PropertyOptions: []rentWorkspacePropertyOption{{ID: 7, Name: "78 Old County Road"}},
